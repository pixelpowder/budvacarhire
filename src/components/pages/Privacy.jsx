...
export default function Privacy() {
  ...
  return (
    ...
    >
      ...
      <p>{t('privacyBody.whoText') || 'Budva Car Hire operates as an affiliate partner connecting travellers with car rental providers in Budva, Montenegro. Our website is located at budvacarhire.com. When you use our site, we may collect certain information as described below.'}</p>
      ...
      <p>{t('privacyBody.contactText') || 'For any privacy-related questions, contact us via email at info@budvacarhire.com.'}</p>
    </ContentPage>
  );
}
